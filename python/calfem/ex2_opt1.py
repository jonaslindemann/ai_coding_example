...
def run_case(el_size_factor):
    ...
    for eltopo, elx, ely, elMarker in zip(edof, ex, ey, elementmarkers):
        ...
        # CALFEM edof numbering is 1-based; scipy sparse matrices are 0-based.
        dof_idx = np.asarray(eltopo, dtype=np.int64) - 1
        rr, cc = np.meshgrid(dof_idx, dof_idx, indexing="ij")
